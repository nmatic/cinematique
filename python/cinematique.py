...
def Cinematique():
    ...
    print('Bienvenue sur le Calculateur de la Cin�matique')
    print('par VB')
    ...
    # Demande de la donn�e recherch�e:
    print('Quelle donn�e recherchez-vous?')
    print('[xi : 1, xf : 2, vi : 3, vf : 4, d_t : 5, a : 6]')
    donneeR = int(input())

    # Demande des donn�es connues:
    print('Quelles donn�es connaissez-vous?')
    print('Oui = 1, Non = 0')
    ...
    #Si: donneeR == 6:
        ...
        print('Impossible � calculer � partir des donn�es connues.')
